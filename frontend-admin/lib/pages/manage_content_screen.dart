...
class _ContentModerationPageState extends State<ContentModerationPage> {
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              // TODO: Llamar DELETE /api/content/:id con autenticación JWT
  ...
  void _handleAction(String id, String actionType) {
    // TODO: Abrir vista previa o detalles desde backend
    ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('🎛️ Content Moderation'),
...
// Tabla de contenido modular reutilizable
    ...
    return Drawer(
      child: ListView(
        ...
        children: const [
          ...
          _SidebarItem(title: 'Content Moderation', route: '/manage-content', isActive: true),
